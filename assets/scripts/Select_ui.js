...
var Select_ui=cc.Class({
    ...
    On_ConfirmButton_Clicked:function(){
		var Map_ALL=this.map_ALL;
		if(Select_ui.game_scene!="game_scene")
		cc.director.loadScene(Select_ui.game_scene);
		else
		cc.log("请选中任意关卡！");
	},
